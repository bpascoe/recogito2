    ...
    PlaceUtils.initGazetteers().done(function() {
      API.listAnnotationsInPart(Config.documentId, Config.partSequenceNo)
         .done(function(annotations) {
          ...
          var pattern = /([-+]?([1-8]?\d(\.\d+)?|90(\.0+)?),\s*[-+]?(180(\.0+)?|((1[0-7]\d)|([1-9]?\d))(\.\d+)?)|([0-8]?\d°\s*([0-5]?\d'\s*)?([0-5]?\d(\.\d{1,6})?("|(''))?)?|90°\s*0?0'\s*0?0("|(''))?)\s{0,}[NnSs],?\s*([0-1]?[0-7]?\d°\s*([0-5]?\d'\s*)?([0-5]?\d(\.\d{1,6})?("|(''))?|180°\s*0?0'\s*0?0("|(''))?)?)\s{0,}[EeOoWw])/g;
          var pattern2 = /([-+]?([1-8]?\d(\.\d+)?|90(\.0+)?),\s*[-+]?(180(\.0+)?|((1[0-7]\d)|([1-9]?\d))(\.\d+)?)|([0-8]?\d°\s*([0-5]?\d'\s*)?([0-5]?\d(\.\d{1,6})?("|(''))?)?|90°\s*0?0'\s*0?0("|(''))?)\s{0,}[NnSs],?\s*([0-1]?[0-7]?\d°\s*([0-5]?\d'\s*)?([0-5]?\d(\.\d{1,6})?("|(''))?|180°\s*0?0'\s*0?0("|(''))?)?)\s{0,}[EeOoWw])<\/span>/;
