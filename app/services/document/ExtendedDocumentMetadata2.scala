...
case class ExtendedDocumentMetadata2(document: DocumentRecord, fileparts: DocumentFilepartRecord, owner: UserRecord) {
  ...
  lazy val textParts = fileparts.getContentType.startsWith("TEXT")
  
  lazy val hasTextParts = textParts
  
  lazy val imageParts = fileparts.getContentType.startsWith("TEXT")
  
  lazy val hasImageParts = imageParts
  
  lazy val dataParts = fileparts.getContentType.startsWith("DATA")
  
  lazy val hasDataParts = dataParts
